...
if(cartArray!=null && cartArray.length>0){
  ...
  <div class="card-body  bh">
    ...
    <button class="btn btn-outline-danger" onclick="removeBtn(${i})">Delete</button>
  </div>
</div>`;
  }
}else{
  cartData.innerHTML=`<h2 class="text-center">Your Cart is Empty!...</h2>`
}
}
...
function total(){
  ...
  totalAmount.innerHTML=`<h3 class="text-light text-center mt-5">Total ${totalPrice} PKR <h3/>`
}
